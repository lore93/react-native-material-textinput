  ...
  render() {
    ...
    return (
      <View style={containerStyle}>
        {props.multiline ?
            <>
              <View  style={{zIndex:200,backgroundColor:props.labelBackgroundColor,height:22, width:"100%",top:0,position:"absolute"}}/>
        ...
        <View style={this.props.multiline && {zIndex:100}}>
          <TextInput
            {...props}
            style={inputStyle}
